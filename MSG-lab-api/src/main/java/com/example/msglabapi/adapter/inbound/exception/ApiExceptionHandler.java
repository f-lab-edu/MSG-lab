...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(value = {
            HttpMessageConversionException.class, HttpMessageNotReadableException.class,
    ...
    public ResponseEntity<ExceptionBody> handleException(RuntimeException e, HttpServletRequest request) {
        ...
        final ExceptionBody exceptionBody = new ExceptionBody(httpStatus.getReasonPhrase(), "400",
                                                              e.getMessage());
